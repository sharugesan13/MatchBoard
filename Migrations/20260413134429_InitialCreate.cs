...
namespace MatchBoard.Web.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ResearchAreas",
                columns: new[] { "Id", "IsActive", "Name", "Tag" },
                values: new object[,]
                {
                    { 1, true, "Artificial Intelligence", "AI" },
                    { 2, true, "Web Development", "WEB" },
                    { 3, true, "Cybersecurity", "CYBER" },
                    { 4, true, "Machine Learning", "ML" },
                    { 5, true, "Cloud Computing", "CLOUD" },
                    { 6, true, "Mobile Development", "MOBILE" }
                });
